...
class ProductListTableViewCell: UITableViewCell, ISMAppearanceProvider {
...
//        Fonts.setFont(label, fontFamiy: .monstserrat(.Bold), size: .custom(14), color: .black)
    ...
    lazy var actionButton: UIButton = {
        ...
        button.setTitle("Add Discount", for: .normal)
    ...
    func manageData(){
        ...
        let discountType = ProductDiscountType(rawValue: productData.liveStreamfinalPriceList?.discountType ?? 0)
...
//        }
        ...
        func normalPricingFlow(){
            ...
            if discountedPercentage == 0 {
                ...
                actionButton.setTitle("Add Discount", for: .normal)
                actionButton.setTitleColor(appearance.colors.appSecondary, for: .normal)
                ...
                actionButton.setTitle(isOfferEditable ? "Update Discount" : "Remove Discount", for: .normal)
                actionButton.setTitleColor(isOfferEditable ? .red : .gray, for: .normal)
            }
        }
