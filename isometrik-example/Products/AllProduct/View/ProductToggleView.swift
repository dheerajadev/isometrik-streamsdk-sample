...
class ProductToggleView: UIView, ISMAppearanceProvider {
    ...
    lazy var myStoreButton: UIButton = {
        ...
        button.setTitle("My Store", for: .normal)
    ...
    lazy var otherStoreButton: UIButton = {
        let button = UIButton()
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setTitle("Other Stores", for: .normal)
        button.titleLabel?.font = appearance.font.getFont(forTypo: .h7)
        button.layer.cornerRadius = 22.5
        return button
    }()
    ...
    func updateUI(activeButton: ProductsForm = .myStore){
        
        switch activeButton {
        case .myStore:
            
            otherStoreButton.setTitleColor(.lightGray, for: .normal)
        ...
        case .otherStore:
            ...
            myStoreButton.setTitleColor(.lightGray, for: .normal)
