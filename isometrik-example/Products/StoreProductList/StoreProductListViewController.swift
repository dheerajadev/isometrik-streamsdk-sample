...
class StoreProductListViewController: UIViewController, ISMAppearanceProvider {
    ...
    var storeTitle: String? {
        didSet {
            headerView.headerTitle.attributedText = headerView.attributedHeaderTitle(title: "Products in", subtitle: storeTitle ?? "")
        }
    }
...
//        Fonts.setFont(view.headerTitle, fontFamiy: .monstserrat(.Bold), size: .custom(18), color: .black)
    ...
    lazy var continueButton: UIButton = {
        ...
        button.setTitle("Add Products", for: .normal)
//        Fonts.setFont(button.titleLabel!, fontFamiy: .monstserrat(.SemiBold), size: .custom(14), color: .white)
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            ...
            self.defaultView.defaultLabel.text = "No Products in this Store"
        }
    }
