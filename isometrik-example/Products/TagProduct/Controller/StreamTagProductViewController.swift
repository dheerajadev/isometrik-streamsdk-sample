...
class StreamTagProductViewController: UIViewController, ISMAppearanceProvider {
    ...
    lazy var headerView: CustomHeaderView = {
        ...
        view.headerTitle.text = "Tag Products"
        ...
        view.trailingActionButton2.setTitle("+" + "Add", for: .normal)
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async {
            ...
            self.defaultView.defaultLabel.text = "No tagged product found"
        }
    ...
    @objc func addButtonTapped(){
        ...
        let viewModel = ProductViewModel(routeType: .push)
        viewModel.isOfferEditable = true
        viewModel.isFromLive = true
        ...
        controller.headerView.headerTitle.text = "Add Products"
