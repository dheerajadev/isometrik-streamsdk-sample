...
class StreamTagProductTableViewCell: UITableViewCell, ISMAppearanceProvider {
...
//        Fonts.setFont(label, fontFamiy: .monstserrat(.Bold), size: .custom(14), color: .black)
    ...
    lazy var pinItemButton: UIButton = {
        ...
        button.setTitle("Pin Item", for: .normal)
